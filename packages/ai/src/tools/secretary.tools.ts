...
export const CreateRoadmapSchema = z.object({
  ...
  milestones: z
    ...
    .optional()
    .describe('Key milestones to achieve'),
  preferences: z
    .object({
...
export const ListMemoryFilesSchema = z.object({
  includeContent: z
    ...
    .optional()
    .default(false)
    .describe('Include content preview in listing'),
})
...
export const GetRoadmapSchema = z.object({
  roadmapId: z
    ...
    .uuid()
    .optional()
    .describe('Specific roadmap ID, or get all active roadmaps'),
  status: z
    .enum(['active', 'completed', 'archived', 'paused', 'all'])
    .optional()
    .default('active')
...
export async function createRoadmap(
  ...
  try {
    ...
    const { error } = await ctx.supabase.from('learning_roadmaps').insert({
      id: roadmapId,
      user_id: ctx.userId,
      title: roadmap.title,
...
export async function getRoadmap(
  ...
  try {
    let query = ctx.supabase.from('learning_roadmaps').select('*').eq('user_id', ctx.userId)
...
export const secretaryTools = [
  {
    name: 'create_roadmap',
    description: 'Create a new learning roadmap with phases, weeks, and milestones',
    schema: CreateRoadmapSchema,
    execute: createRoadmap,
  },
  {
    name: 'save_roadmap',
    description: 'Save or update an existing learning roadmap',
    schema: SaveRoadmapSchema,
    execute: saveRoadmap,
  },
  {
    name: 'list_memory_files',
    description: 'List all AI memory types (preferences, plans, daily notes)',
    schema: ListMemoryFilesSchema,
    execute: listMemoryFiles,
  },
  {
    name: 'delete_memory_file',
    description: 'Delete a specific AI memory type',
    schema: DeleteMemorySchema,
    execute: deleteMemory,
  },
  {
    name: 'get_roadmap',
    description: 'Get learning roadmaps by ID or filter by status',
    schema: GetRoadmapSchema,
    execute: getRoadmap,
  },
  {
    name: 'advance_roadmap_week',
    description: 'Advance a roadmap to the next week',
    schema: AdvanceRoadmapWeekSchema,
    execute: advanceRoadmapWeek,
  },
  {
    name: 'get_current_week_tasks',
    description: 'Get the current week tasks and focus from a roadmap',
    schema: GetCurrentWeekTasksSchema,
    execute: getCurrentWeekTasks,
  },
] as const
