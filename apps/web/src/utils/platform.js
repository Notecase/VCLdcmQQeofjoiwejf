...
// Image utilities
export async function loadImageAsDataURL(file) {
...
export function openFileDialog(accept = '.md,.markdown,.txt') {
...
// Export HTML file
export function exportHTML(content, filename = 'document.html') {
